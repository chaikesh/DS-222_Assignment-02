...
with graph.as_default():
    ...
    learning_rate = tf.train.exponential_decay(starter_learning_rate, global_step,
                                           decay_steps=num_examples/batch_size, decay_rate=1.06, staircase=True)
...
np.save('cost_plot_increase',cost_plot)
np.save('test_plot_increase',test_plot)    
